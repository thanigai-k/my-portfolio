...
export const nav = [
  ...
  { label: 'Experiences', href: '/experiences', rail: true, tab: true },
  { label: 'Side projects', href: '/projects', rail: true, tab: false },
  { label: 'Writing', href: '/writing', rail: false, tab: false },
...
export const socials = [
  ...
  { label: 'linkedin', href: 'https://www.linkedin.com/in/thanigai-breathes-tech/' },
